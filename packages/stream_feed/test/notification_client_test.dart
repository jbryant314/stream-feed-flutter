...
void main() {
  group('NotificationFeed Client', () {
    ...
    test('getActivityDetail', () async {
      ...
      expect(
        activities,
        rawActivities.map((e) => NotificationGroup.fromJson(e, (json) => Activity.fromJson(json as Map<String, dynamic>?))).toList(growable: false).first,
      );
    ...
    test('getActivities', () async {
      ...
      expect(
        activities,
        rawActivities.map((e) => NotificationGroup.fromJson(e, (json) => Activity.fromJson(json as Map<String, dynamic>?))).toList(growable: false),
      );
      verify(() => api.getActivities(token, feedId, options)).called(1);
    });
    ...
    test('getEnrichedActivities', () async {
      ...
      expect(
        activities,
        rawActivities.map((e) => NotificationGroup.fromJson(e, (json) => GenericEnrichedActivity<String, String, String, String>.fromJson(json as Map<String, dynamic>?))).toList(growable: false),
      );
